...
**Kind:** `isolated_full_regression` &nbsp; **Build:** `phase_b_all_cases` &nbsp; **Bucket:** `all_buckets` &nbsp; **Sequence:** `make -C tb/uvm regress`
...
|---:|---|---|---|---:|---|
| 530874 | `all_buckets` | `phase_b_all_cases` | 100.0 | 512 | scorecard_cross_validate |
