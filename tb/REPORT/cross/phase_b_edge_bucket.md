...
**Kind:** `isolated_bucket_merge` &nbsp; **Build:** `phase_b_all_cases` &nbsp; **Bucket:** `EDGE` &nbsp; **Sequence:** `vcover merge edge bucket UCDBs`
...
|---:|---|---|---|---:|---|
| 143455 | `EDGE` | `phase_b_edge_bucket` | 100.0 | 128 | scorecard_cross_validate |
