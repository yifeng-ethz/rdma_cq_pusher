# ✅ phase_b_basic_bucket

**Kind:** `isolated_bucket_merge` &nbsp; **Build:** `phase_b_all_cases` &nbsp; **Bucket:** `BASIC` &nbsp; **Sequence:** `vcover merge basic bucket UCDBs`
...
|---:|---|---|---|---:|---|
| 754 | `BASIC` | `phase_b_basic_bucket` | 100.0 | 128 | scorecard_cross_validate |
